...
{\bf Expert:}{ R (including the \href{https://www.tidyverse.org}{tidyverse})}\\
{\bf Proficient:}{ Julia, Git, GitHub, QGIS, R Markdown, \LaTeX, Microsoft Excel, Word, and PowerPoint}\\
{\bf Experienced:}{ Matlab, ArcGIS, Jupyter notebooks}\\
{\bf Acquainted:}{ Python, Fortran, shell scripting, SQL}
\end{rSection}
